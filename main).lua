...
local function Text(am, an)
    return ab("TextLabel", {
        ...
        TextTransparency = af.Color and (an == "Desc" and 0.3 or 0),
        TextWrapped = true,
        Size = UDim2.new(1, 0, 0, 0),
        AutomaticSize = "Y",
        FontFace = Font.new("rbxasset://fonts/families/SourceHanSansCN.json", Enum.FontWeight.Medium)  -- 强制使用思源黑体
    })
end
